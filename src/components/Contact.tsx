...
export const Contact = () => {
  ...
  return (
    <section className="min-h-screen bg-base-200 text-base-content px-8 py-16 text-center">
      ...
      <p className="mt-10 text-sm text-gray-500 dark:text-gray-400">
        또는 직접 연락: <br />
        <span className="font-semibold text-base text-gray-400 dark:text-white">
          010-4034-9278
        </span>
      </p>
    </section>
