...
const projects = [
    ...
    },
    {
      ...
      description:
        "대학정보시스템 UI 전환 사업\n" +
        "- 기존 WebSquare 2.0 시스템을 WebSquare 5.0으로 리뉴얼\n" +
  ...
  export const Projects = () => {
    ...
    return (
      ...
      <section className="min-h-screen bg-base-200 text-base-content px-8 py-16">
  ...
  {projects
    ...
    .map((p) => (
      <div key={p.title} className="bg-white dark:bg-zinc-800 p-6 rounded-xl shadow-md space-y-2">
        ...
        <p className="whitespace-pre-line text-sm text-gray-700 dark:text-gray-300">{p.description}</p>
      </div>
    ))}
</div>
      </section>
